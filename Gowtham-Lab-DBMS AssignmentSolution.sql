Create Database if not exists `ecommerce-directory` ;
use `ecommerce-directory`;
...
from orders o inner join productdetails p
...
select s.*
from supplier s,productdetails p
...
from orders o inner join productdetails pd on o.prod_id=pd.prod_id
